  ...
  return (
    <div ref={containerRef} className="relative w-full h-[300vh] bg-[#F7F8FA]">
      ...
      <div className="sticky top-0 w-full h-screen overflow-hidden flex flex-col md:flex-row items-center justify-center pt-20">
        ...
        <div className="relative w-full md:w-1/2 h-full z-10 perspective-1000 px-6 md:px-12 flex items-center">
          ...
          <div className="relative w-full z-20 pointer-events-none mix-blend-darken">
            <h1 className="font-display text-5xl md:text-7xl font-bold text-[#1A1A1A] leading-[0.95] tracking-tight max-w-3xl">
              Streamline the <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2563EB] to-[#60A5FA] font-extrabold">
                Gig Economy.
              </span>
            </h1>
            {/* Scroll Indicator */}
        ...
        >
          <div
            className={`group relative flex items-center justify-center w-24 h-24 rounded-full border-4 shadow-2xl transition-colors duration-500 ${
              isComplete ? 'bg-[#10B981] border-[#10B981]' : 'bg-white border-[#2563EB]'
            }`}
          >
            {isComplete ? (
          ...
          >
            ...
            <div className="bg-white border-b border-[#F3F4F6] p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#2563EB] rounded-lg flex items-center justify-center text-white font-display font-bold shadow-lg shadow-blue-500/30 text-lg">
                  O
                </div>
                <div>
            ...
            <div
              className={`p-3 text-[10px] text-center border-t border-[#F3F4F6] font-bold tracking-widest uppercase transition-colors duration-500 font-mono ${
                isComplete ? 'bg-[#10B981]/10 text-[#10B981]' : 'bg-gray-50 text-gray-400'
              }`}
            >
  ...
  <section className="py-24 px-6 bg-white relative overflow-hidden">
    <div className="container mx-auto max-w-7xl">
      <div className="text-center mb-20">
        <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-4 tracking-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 relative">
        ...
        {[
          ...
          <div
            key={i}
            className={`relative z-10 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center group ${step.border}`}
          >
            <div
              className={`w-14 h-14 rounded-2xl ${step.bg} ${step.color} flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 shadow-sm`}
            >
        ...
        <div className="p-12 bg-gray-50 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="font-bold text-[#1A1A1A] uppercase tracking-widest text-xs font-mono">
                Problem: Fragmented Workflows
              </h3>
            </div>
            ...
            <div className="space-y-5 font-mono text-xs md:text-sm">
              ...
              <div
                className="bg-blue-50 p-4 rounded-2xl rounded-tr-none border border-blue-100 shadow-sm w-4/5 ml-auto text-right animate-enter"
              ...
              <div
                className="bg-white p-4 rounded-2xl rounded-tl-none border border-gray-200 shadow-sm w-3/4 animate-enter"
        ...
        <div className="p-12 bg-white relative border-l border-gray-100">
          ...
          <div className="space-y-6">
            ...
            <div className="group relative pl-6 border-l-2 border-[#2563EB] hover:border-l-4 transition-all">
              <div className="text-[10px] text-gray-400 uppercase font-bold mb-2 tracking-wider font-mono">
                Smart Allocation
              </div>
              <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] bg-white border px-2 py-0.5 rounded text-gray-500 font-mono">
                  Roster Checked
                </span>
              </div>
            </div>
            ...
            <div className="group relative pl-6 border-l-2 border-[#F59E0B] hover:border-l-4 transition-all">
              ...
              <div className="flex gap-3 mt-2">
                <span className="px-3 py-1.5 bg-gray-900 text-white rounded-md text-xs font-bold shadow-md font-mono">
                  Briefs Distributed
                </span>
                <span className="px-3 py-1.5 bg-green-50 text-[#10B981] border border-green-100 rounded-md text-xs font-bold font-mono">
                  High Conversion
                </span>
              </div>
            </div>
    ...
    <div className="min-h-screen bg-[#F7F8FA] text-[#1A1A1A] font-sans selection:bg-[#2563EB] selection:text-white">
      ...
      <nav className="fixed w-full z-50 bg-white/70 backdrop-blur-lg border-b border-gray-100 supports-[backdrop-filter]:bg-white/60">
        <div className="container mx-auto px-6 h-20 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#1A1A1A] text-white flex items-center justify-center rounded-xl font-bold text-xl shadow-lg font-display">
              O
            </div>
